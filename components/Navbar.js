...
const Navbar = () => {
    ...
    return (
        <header className="text-gray-600 bg-slate-200">
            ...
            <div className={`container mx-auto md:flex flex-wrap p-5 flex-col md:flex-row items-center ${navbar ? "block" : "hidden"
        }`}
>
                ...
                <nav className=" flex-col md:flex-row md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap md:items-center text-base md:justify-center">
