...
// import colorfulText from "./Footer.css"
const Footer = () => {


    return (
        <footer className="text-gray-600 bg-slate-200">
            <hr className='mt-24' />
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-wrap md:text-left text-center order-first">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="title-font font-medium text-gray-900 tracking-widest text-lg mb-3">Visit</h2>
                        <nav className="list-none mb-10">
                            <li><Link href="/" className="text-gray-600 hover:text-black">Home</Link></li>

                            <li><Link href="/" className="text-gray-600 hover:text-black">Product</Link></li>
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <Link href="/" className="text-gray-600 hover:text-black">First Link</Link>
                            </li>
                            <li>
                                <Link href="/" className="text-gray-600 hover:text-black">Second Link</Link>
                            </li>
                            <li>
                                <Link href="/" className="text-gray-600 hover:text-black">Third Link</Link>
                            </li>
                            <li>
                                <Link href="/" className="text-gray-600 hover:text-black">Fourth Link</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                    ...
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        <h2 className="title-font font-medium text-gray-900 tracking-widest text-lg mb-3">SUBSCRIBE</h2>
            ...
            <div className="bg-gray-100">
                <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    <Link href="/" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        ...
                        <span className="ml-3 text-xl ">Aurora Book Store</span>
                    </Link>
                    <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4 colorfulText">© 2023 Aurora Book Store —
