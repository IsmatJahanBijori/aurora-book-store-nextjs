            ...
            <div className="mt-4 " onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                ...
                <div className={` ${isHovered ? 'opacity-100' : 'opacity-0'} mb-2`}>
                    <div className='flex flex-col  '>
                        <Link href={""}><button data-aos="fade-left" className="lg:mt-2 xl:mt-0  text-white bg-indigo-500 border-0 py-2 px-6 w-3/5 focus:outline-none hover:bg-indigo-600 rounded my-2">Buy Now</button></Link>
                        <Link href={`/product/${id}`}><button data-aos="fade-right" className="lg:mt-2 xl:mt-0 text-white bg-indigo-500 w-3/5 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">View Details</button></Link>
                    </div>
                </div>
            </div>
        </div>
